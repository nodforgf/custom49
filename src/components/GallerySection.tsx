...
function PhotoCard({ photoUrl, idx, style, photoDate }: PhotoCardProps) {
  ...
  const messages = [
    "ตอนเด็กแฟนเค้าโคตรน่ารักเลยหล่ะ",
    "เห็นใจเด่กน้อยคนนี้โหน่ยย มากอดเค้านี่มา",
    "จำได้มั้ยคะ ครั้งแรกที่เราเจอกันจริงๆพี่หล่อมากก",
    "ไอไม้ของพี่รอพี่มาเล่นด้วยอยู่นะคะ",
    "เค้าชอบเสียงพี่มากๆเลยนะรู้มั้ย คนอะไรหน้าตาก็หล่อ เสียงยังหล่อ",
    "จำดอกไม้อันนี้ได้แมะะ เค้าตั้งใจเก่บมาให้พี่เลยนะเกือบตกสระ55555",
  ];
