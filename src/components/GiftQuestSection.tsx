...
export default function GiftQuestSection({ onBack, onFinish }: { onBack: () => void, onFinish: () => void }) {
    ...
    const GIFTS = [
        "ดูหนังกันนน 🎬", "เค้าซื้อของให้้ แต่ไม่บอกหรอกคืออาราย 🎁", "มาจุ๊บทีนึงงง 😚", "เปิดกล้อง1วัน 📱",
        "มาเล่นเกมแก้เครียดนี่มา 🎮", "ให้เรียนเหลือแค่ชมเดียว 📚", "อัดเสียงบอกรักทุ๊กกกกวันน 💞", "หูฟังส่วนตัว พร้อมรับฟังทุกเรื่อง 🎧"
    ];
