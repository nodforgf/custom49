...
export default function AnniversaryPage({ onFinish }: AnniversarySectionProps) {
  ...
  // 🎯 ย้ายหัวใจไปวันอังคารที่ 7 กรกฎาคม เรียบร้อยครับ
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-[#fce4ec] flex items-center justify-center p-4 font-sans">
      ...
      >
        ...
        />
        <div className="absolute -top-2 right-10 w-24 h-10 bg-[#f4a7be]/30 backdrop-blur-[2px] rotate-[15deg] border-x border-[#f4a7be]/10 z-30" />
        ...
        >
          <div className="text-center mb-6 relative px-4">
            ...
            <h1 className="text-[#c2547a] text-2xl font-black tracking-tighter uppercase italic leading-none">START AGAIN TOGETHER</h1>
