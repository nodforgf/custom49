...
const WISHES = [
  { id: 1,  text: "ไปเที่ยวเชียงใหม่กับพี่ซักครั้ง👩🏻‍❤️‍👨🏻",                color: "#ffd6e7" },
  { id: 2,  text: "เรียนด้วยกันในวันที่ว่าง🥇", color: "#fce4ec" },
  { id: 3,  text: "เล่นRobloxด้วยกันนน😻",        color: "#fff0f8" },
  { id: 4,  text: "ติวสอบให้พี่ได้ติดนรต.♥️",           color: "#ffd6e7" },
  { id: 5,  text: "ซื้อทุกอย่างที่พี่ต้องการให้🤏🏻",          color: "#fce4ec" },
  { id: 6,  text: "มีอนาคตแล้วมีพี่อยู่ในนั้น💞",  color: "#fff0f8" },
  { id: 7,  text: "แต่งงานกับพี่คบกับพี่คนเดียวในชีวิตนี้🫶🏻",          color: "#ffd6e7" },
  { id: 8,  text: "ไปเล่นน้ำทะเลด้วยกันสองคน😚",         color: "#fce4ec" },
  { id: 9,  text: "อยากกอดพี่ทุกครั้งเวลาที่พี่เสียใจ😕",            color: "#fff0f8" },
  { id: 10, text: "เค้าอยากซื้อรถให้พี่🙆🏻‍♀️",            color: "#ffd6e7" },
];
