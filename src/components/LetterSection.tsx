                            ...
                            <div className="bg-[#fff8fb] rounded-2xl shadow-[0_20px_50px_rgba(232,120,154,0.25)] border border-[#f4a7be]/40 overflow-hidden">
                                ...
                                <div className="px-7 py-6 text-[#c2547a] space-y-4">
                                    ...
                                    <div className="text-xs leading-7 space-y-3 italic text-[#c2547a]/75">
                                        <p>ถึงแม้ว่าตอนนี้พี่อาจจะยังผ่านความรู้สึกนี้มาไม่ได้ แต่พี่รู้มั้ย พี่เป็นคนที่เก่งที่สุดเลยนะเก่งมากๆเลยด้วย ถึงอะไรจะไม่เป็นใจบ้างก็ตาม ที่ผ่านมาพี่คงเหนื่อยมาก เค้าก็เสียใจที่ไม่ได้ไปดูแลพี่ให้ดีที่สุด เค้าอยากจะขอโทษพี่ในจุดนี้ แต่อะไรที่เค้าพอทำได้เค้าก็จะทำพี่บอกมาได้เลยนะ ถ้าเป็นไปได้เค้าก็อยากจะไปกอดพี่นะตรงนั้นตอนที่พี่รู้สึกแย่ๆ อยากให้พี่มานอนพักผ่อนมานอนซบอกเค้า แต่ตอนนี้เค้าขอบคุณพี่มากๆเลยที่ยังไม่ยอมแพ้ไปไหน เค้าเชื่อว่าต่อจากนี้เราจะเริ่มต้นใหม่ไปด้วยกันนะ อะไรพังแล้วก็ปล่อยวางมันถึงมันจะยากก็เถอะ เค้าจะอยู่เป็นกำลังใจให้พี่เองนะ เค้าเองก็เป็นคนนึงที่ห่วงพี่มากที่สุดไม่ต่างอะไรกับแม่พี่เลย เค้าอยากไปดูแลพี่ให้ดีที่สุด รักพี่มากๆเลยนะคะ อย่าพยายามคิดอะไรไม่ดีเลยนะ จากคนที่รักพี่สุดหัวใจ🫶🏻</p>
                                    </div>
